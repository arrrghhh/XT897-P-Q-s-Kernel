...
#  define machine_arch_type	__machine_arch_type
# else
#  define machine_arch_type	MACH_TYPE_QINARA
# endif
# define machine_is_qinara()	(machine_arch_type == MACH_TYPE_QINARA)
#else
# define machine_is_qinara()	(0)
#endif
